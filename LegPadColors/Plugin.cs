...
{
    public static string MOD_NAME = "LegPadColors";
    public static string MOD_VERSION = "1.0.0";
    public static string MOD_GUID = "LegPadColors";
    ...
    // public static PlayerInput playerInput = NetworkBehaviourSingleton<PlayerInput>.Instance;
